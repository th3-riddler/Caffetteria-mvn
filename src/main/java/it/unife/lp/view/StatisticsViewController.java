...
public class StatisticsViewController {
    ...
    private void handleLoadDailyRevenue() {
        // Map<Articolo, Integer> dailySales = StatisticsUtil.dailySalesMap(mainApp.getOrdini(), dailySalesDatePicker.getValue());
        this.mainApp.showDailyRevenueDialog(/*dailySales, */dailySalesDatePicker.getValue());
    }
}
